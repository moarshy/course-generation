...
import { CourseCreate } from '@/lib/types';
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-8 py-6 border-b border-blue-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-2xl font-bold text-blue-900">Create New Course</h3>
              </div>
              <button
                onClick={handleClose}
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  type="text"
                  id="title"
                  className={`w-full px-4 py-4 text-lg font-medium border-2 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 ${
              ...
              <div>
                ...
                <textarea
                  ...
                  id="description"
                  rows={4}
                  className={`w-full px-4 py-4 text-lg font-medium border-2 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 resize-none ${
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 mt-1">
                      After creation, you can generate course content using our AI-powered system that analyzes repositories and creates comprehensive learning materials.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex justify-end space-x-4 pt-6">
                ...
                <button
                  ...
                  className="px-8 py-3 text-base font-bold text-white bg-blue-600 border-2 border-blue-600 rounded-xl hover:bg-blue-700 hover:border-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl"
                >
                  {isSubmitting ? (
