...
class CourseGenerationService:
    ...
    def __init__(self):
        ...
        self.celery_app = Celery('naptha_course_creator')
    ...
    def _get_course_dir(self, user_id: str, course_id: str) -> Path:
        ...
        base_data_dir = Path(settings.ROOT_DATA_DIR)
        course_dir = base_data_dir / safe_user_id / course_id
        logger.info(f"course_dir: {course_dir}")
        return course_dir
    ...
    def get_stage2_result(self, course_id: str) -> Optional['Stage2Response']:
        ...
        try:
            ...
            try:
                ...
                document_tree_file = course_dir / "document_analysis_tree.pkl"
    ...
    def get_course_export_path(self, user_id: str, course_id: str) -> Path:
        ...
        course_dir = self._get_course_dir(user_id, course_id)
        course_dir = course_dir / "generated" / "default"
        return course_dir
