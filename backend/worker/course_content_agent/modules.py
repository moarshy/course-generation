...
class LearningPathGenerator(dspy.Module):
    ...
    def forward(self, documents: List[DocumentNode], complexity: ComplexityLevel, 
        ...
        try:
            ...
            modules = self._parse_modules_from_llm(cluster_result.modules, documents, complexity)
    ...
    def _parse_modules_from_llm(self, modules_json: str, documents: List[DocumentNode], complexity: ComplexityLevel) -> List[LearningModule]:
        ...
        for i, module_data in enumerate(modules_data):
            try:
                ...
                module = LearningModule(
                    ...
                    learning_objectives=learning_objectives,
                    linked_documents=valid_linked_docs,
                    target_complexity=complexity,
...
class CourseGenerator(dspy.Module):
    ...
    def _get_source_documents_content(self, module: LearningModule, tree: DocumentTree) -> str:
        ...
        logger.info(f"Getting source documents for module {module.title}: {module.linked_documents}")
        
        for doc_path in module.linked_documents:
